...
LEAKAGE_ANALYSIS_ENABLED = False  # True para anÃ¡lisis exhaustivo de leakage (puede ser costoso en datasets grandes)
...
def write_non_trainable_outputs(
    *,
    ...
    print(f"===== FASE {PHASE} COMPLETADA SIN ENTRENAMIENTO â€” variante {variant} =====")
...
def main():
    ...
    parent_f01 = exports_parent.get("parent_f01")
